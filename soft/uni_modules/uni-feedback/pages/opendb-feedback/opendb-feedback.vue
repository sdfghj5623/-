<template>
	<view class="uni-container">
		<uni-forms ref="form" :value="formData" validate-trigger="submit" err-show-type="toast">
			...
			<uni-forms-item name="user_id" label="用户id" v-if="showIcon1" class="hidden">
				<uni-easyinput v-model="formData.user_id" trim="both"></uni-easyinput>
			</uni-forms-item>
			<view class="uni-button-group">
				<button type="primary" class="uni-button" @click="submit">提交</button>
			</view>
		</uni-forms>
		<image src="../../../../static/search.png" class="search" @click="tiao" v-if="showIcon1"></image>
	</view>
</template>

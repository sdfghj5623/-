<template>
	...
	在新梢枝叶生长期，要追施氮、磷、钾复合肥，进行灌水，催促枝条生长。
	在生长期还要进行叶面追肥，这是见效快，流失少，省工、省肥的好方法。
	一般叶面喷肥后3~5天，新梢和叶片就能变成浓绿色，提高光合效率。
	根外追肥施用的浓度，尿素为0.2%~0.3%，过磷酸钙浸出液为1%~3%，
	磷酸二氢钾和硫酸钾为0.3%~0.5%，硼砂、硫酸锌、硫酸镁和硫酸锰等为0.1%~0.3%。
	上述肥料除过磷酸钙外，都可与波尔多液混合喷施。</view>
	</view>

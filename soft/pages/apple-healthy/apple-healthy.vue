<template>
	...
	技术上要掌握好：刮、涂、喷、清即可。刮，就是在每年的初春，苹果开始授粉前，
		先把果树上原有的腐烂病斑、老质翘皮以及轮纹病病瘤统统先清除；涂，就是在清除病斑的
		部位用树将军等既能杀灭细菌又能保护树膜的药物，对树的伤口进行治愈；喷，
		就是在种植的全园范围内，对整个园子用3到5波美度的石硫合剂或<text class="strong">20</text>倍液腐必清经行一次喷射；
		清，就是对果树上所有的病枝、病果、落叶等进行清除，或者就地掩埋。</view>
	</view>

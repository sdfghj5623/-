<template>
	...
	<view class="view diser">
		<text class="bing">黑腐病</text>
	</view>
	<view class="view idea">
		<view class="o">
		<view class="headline">预防措施  精度：{{score}}%</view>
	对于已发生穗轴黑腐病的葡萄种植基地，若穗轴上为淡褐色水渍状病斑，可喷洒50%多菌灵800倍液、
	75%百菌清750倍液，连续喷酒2次，每间隔10 d喷洒1次,在穗轴上病斑演变为深褐色、稍凹陷形状后，
	可喷洒80%代森锰锌可湿性粉剂650~750倍液或78%波尔·锰锌可湿性粉剂550~650倍液，连续喷酒2次</view>
	</view>

<template>
	...
	<view class="view diser">
		<text class="bing">黄化曲叶病</text>
	</view>
	<view class="view idea">
		<view class="o">
		<view class="headline">预防措施  精度：{{score}}%</view>
	培育无病虫的健壮苗：集中统一育苗，消毒基质和土壤，
		分开育苗床和定植田块，错开发病高峰，使用隔离网和黏虫板防虫，
		及时喷施药剂灭杀烟粉虱。加强田间管理：及时清除杂草和病叶，
		先处理健株再处理病株，合理施用肥水，保持田间湿润，适时放风。
		实行轮作换茬：避免与茄科类蔬菜连作，与茄科以外的作物轮作，
		如黄瓜、豆角、葡萄、甘蓝等。
		药剂防治：使用高效低毒的杀虫剂，如阿维菌素、扑虱灵、烯啶虫胺等，
		混合交替使用，轮换用药，避免烟粉虱产生抗药性。</view>
	</view>

<template>
	...
	<view class="view diser">
		<text class="bing">早疫病</text>
	</view>
	<view class="view idea">
		<view class="o">
		<view class="headline">预防措施  精度：{{score}}%</view>
	50%氟啶胺悬浮剂对马铃薯晚疫病的防治效果最佳，施加量为15 g/667 m2终防效超过90%。也可使用25%嘧菌酯悬浮剂(施加量为5 g/667 m2)、
	25%吡唑醚菌酯乳油(施加量为7.5 g/667 m2)，防治效果较好，间隔8~9 d喷酒1次，连续喷洒2~3次。</view>
	</view>

<template>
	...
	<view class="view idea">
		<view class="o">
		<view class="headline">护理建议  精度：{{score}}%</view>
	温度：十五至二十五度这个范围内最适宜叶片生长的，不过块茎生长的适宜温度则是十六至十八度之间。
		由于它对温度的要求较高，若是不提供适宜的温度，就会严重影响其长势。如在二十五度之上，它的块茎就会停止生长了。
		光照：土豆比较怕强光，在成长期时，适当的光照时间是必要的，不然它的果实质量会受到影响，而且口感也不好。
		强光一定得避免，不然叶片可能会干枯。
		浇水：土豆喜湿润，成长期需提供湿润的土壤环境。但夏季多雨的时候，也得及时将地里的积水排掉，不然会危害根系。
		施肥：肥料在土豆的成长中所起的作用还是比较大的，而且可以有效的提高产量。基肥很重要，之后追肥以有机肥为主。</view>
	</view>

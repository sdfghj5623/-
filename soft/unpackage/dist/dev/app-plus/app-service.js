...
(function(vue) {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/index/index.vue"]]);
  ...
  const _sfc_main$6 = {
    ...
    methods: {
      handleLogin() {
        ...
        uni.request({
          url: "http://10.44.126.160:5000/api/login",
          // Flask API 地址
          method: "POST",
          data: loginData,
          header: {
          ...
          success: (res) => {
            formatAppLog("log", "at pages/log/log.vue:93", "Server response:", res);
          ...
          fail: (err) => {
            formatAppLog("error", "at pages/log/log.vue:115", "Request failed:", err);
            uni.showToast({
              title: "网络请求失败",
              icon: "none"
            });
      ...
      toggleAgree(e2) {
        formatAppLog("log", "at pages/log/log.vue:128", "Checkbox changed:", e2);
        this.agree = !this.agree;
        formatAppLog("log", "at pages/log/log.vue:130", this.agree);
      },
      goToForgotPassword() {
        uni.navigateTo({
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createCommentVNode(" 账号密码登录标题 "),
      vue.createElementVNode("view", { class: "title" }, "账号密码登录"),
      ...
      vue.createCommentVNode(" 同意协议勾选框 "),
      vue.createElementVNode("view", { class: "agreement" }, [
        vue.createElementVNode("checkbox", {
          onClick: _cache[2] || (_cache[2] = (...args) => $options.toggleAgree && $options.toggleAgree(...args)),
          class: "checkbox"
        }),
        vue.createElementVNode("text", { class: "agreement-text" }, "同意"),
      ...
      vue.createElementVNode("view", { class: "login-button" }, [
        vue.createElementVNode("button", {
          onClick: _cache[5] || (_cache[5] = (...args) => $options.handleLogin && $options.handleLogin(...args)),
          class: "btn-login"
        }, "登录")
      ]),
      vue.createCommentVNode(" 找回密码和注册账号 "),
      vue.createElementVNode("view", { class: "footer" }, [
        vue.createElementVNode("view", { class: "left" }, [
          vue.createElementVNode("text", {
            onClick: _cache[6] || (_cache[6] = (...args) => $options.goToForgotPassword && $options.goToForgotPassword(...args)),
            class: "footer-link"
          }, "找回密码")
        ]),
  ...
  const PagesLogLog = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-58ca02d5"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/log/log.vue"]]);
  const _sfc_main$5 = {
    data() {
      return {
        username: "",
    ...
    methods: {
      // 注册方法
      register() {
        formatAppLog("log", "at pages/register/register.vue:81", "Register button clicked");
        if (!this.username || !this.password) {
          uni.showToast({
            title: "账号和密码不能为空",
            icon: "none"
        ...
        formatAppLog("log", "at pages/register/register.vue:125", "Sending registration data:", JSON.stringify(userData, null, 2));
        uni.request({
          ...
          success: (res) => {
            formatAppLog("log", "at pages/register/register.vue:135", "Server response:", res);
          ...
          fail: (err) => {
            formatAppLog("error", "at pages/register/register.vue:154", "Request failed:", err);
            uni.showToast({
              title: "网络请求失败",
              icon: "none"
            });
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "agreement" }, [
        vue.createElementVNode("checkbox", {
          onClick: _cache[4] || (_cache[4] = (...args) => $options.toggleAgree && $options.toggleAgree(...args)),
          class: "checkbox"
        }),
        vue.createElementVNode("text", { class: "agreement-text" }, "同意"),
        vue.createElementVNode("text", {
      ...
      vue.createElementVNode("view", { class: "register-button" }, [
        vue.createElementVNode("button", {
      ...
      vue.createElementVNode("view", { class: "back-button" }, [
        vue.createElementVNode("button", {
          onClick: _cache[8] || (_cache[8] = (...args) => $options.back && $options.back(...args)),
          class: "back-login"
        }, "返回")
      ])
    ]);
  }
  const PagesRegisterRegister = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__scopeId", "data-v-bac4a35d"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/register/register.vue"]]);
  const pages = [
    {
...
详细信息：${s4}`), r3(i3);
  ...
  const _sfc_main$4 = {
    ...
    onLoad() {
      ...
      this.showIcon();
      const app = getApp();
      formatAppLog("log", "at pages/news/news.vue:54", "id", app.globalData.userId);
    },
    onReachBottom() {
      this.getData();
    },
    ...
    methods: {
      showIcon() {
        let uid = Ws.getCurrentUserInfo().uid;
        formatAppLog("log", "at pages/news/news.vue:79", uid);
        if (uid === "65e431ab9755e3283074fbf8") {
          this.showIcon1 = true;
        }
      },
      selectNav(nav) {
      ...
      goDetail(e2) {
        let uid = Ws.getCurrentUserInfo().uid;
        formatAppLog("log", "at pages/news/news.vue:90", uid);
        if (uid !== null) {
          uni.navigateTo({
            url: "/pages/details/details?id=" + e2
          });
        } else {
          uni.showToast({
            title: "请登录",
      ...
      getData() {
        ...
        axios$1.get("http://10.44.126.160:5000/api/articles", {
          params: {
            skip,
            limit: 10
          }
        }).then((res) => {
          formatAppLog("log", "at pages/news/news.vue:115", "API Response:", res.data);
          ...
          this.listArr = [...this.listArr, ...articles.map((article) => ({
            ...
            picurls: article.pictures.length > 0 ? article.pictures.map((pic) => {
              if (pic && typeof pic === "string") {
                return `data:image/jpeg;base64,${pic.trim()}`;
              }
              return null;
            }).filter((pic) => pic !== null) : ["../../static/images/nopic.jpg"],
            author: article.leibie
          }))];
          formatAppLog("log", "at pages/news/news.vue:135", "Updated listArr:", this.listArr);
          uni.stopPullDownRefresh();
        }).catch((error) => {
          formatAppLog("error", "at pages/news/news.vue:139", "Error fetching data:", error);
          uni.showToast({
            title: "加载失败，请稍后再试",
            icon: "none",
            duration: 2e3
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_uni_dateformat = vue.resolveComponent("uni-dateformat");
    ...
    return vue.openBlock(), vue.createElementBlock("view", { class: "home" }, [
      vue.createElementVNode("view", { class: "nav" }, [
        vue.createElementVNode(
          "text",
          {
            class: vue.normalizeClass(["item", { active: $data.selectedNav === "policy" }]),
            onClick: _cache[0] || (_cache[0] = ($event) => $options.selectNav("policy"))
          },
          "政策",
          2
          /* CLASS */
        ...
        vue.createElementVNode(
          "text",
          {
            class: vue.normalizeClass(["item", { active: $data.selectedNav === "technology" }]),
            onClick: _cache[1] || (_cache[1] = ($event) => $options.selectNav("technology"))
          },
          "技术",
          2
          /* CLASS */
        ...
        (vue.openBlock(true), vue.createElementBlock(
          ...
          vue.renderList($options.filteredList, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              onClick: ($event) => $options.goDetail(item._id),
              class: "item",
              key: index
            }, [
              ...
              vue.createElementVNode("view", { class: "pic" }, [
                item.picurls && item.picurls.length > 0 ? (vue.openBlock(), vue.createElementBlock("image", {
                  key: 0,
                  src: item.picurls[0],
                  alt: "Article Image",
                  mode: "aspectFill"
      ...
      $data.showIcon1 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "goAdd",
        onClick: _cache[4] || (_cache[4] = (...args) => $options.goAdd && $options.goAdd(...args))
      }, [
  ...
  const PagesNewsNews = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-24bc9d41"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/news/news.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        username: "",
  ...
  const PagesSearchpwSearchpw = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-f68dd34a"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/searchpw/searchpw.vue"]]);
  const _sfc_main$2 = {};
        ...
        [
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.formValue.title = $event),
                type: "text",
                name: "title",
                placeholder: "请输入标题"
              },
              ...
              [vue.vModelText, _ctx.formValue.title]
            ])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.formValue.author = $event),
                type: "text",
                name: "author",
                placeholder: "请输入类型"
              },
              ...
              [vue.vModelText, _ctx.formValue.author]
            ])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              ...
              {
                maxlength: "-1",
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.formValue.content = $event),
                name: "content",
                placeholder: "请输入详细内容"
              },
              null,
              ...
              [vue.vModelText, _ctx.formValue.content]
            ])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.createVNode(_component_uni_file_picker, {
              modelValue: _ctx.imageValue,
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.imageValue = $event),
              fileMediatype: "image",
              mode: "grid",
              onSuccess: _ctx.uploadSuccess
            }, null, 8, ["modelValue", "onSuccess"])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.createElementVNode("button", { "form-type": "reset" }, "重置"),
            vue.createElementVNode("button", {
              "form-type": "submit",
              type: "primary",
              disabled: _ctx.inDisabled(_ctx.formValue)
            }, "提交", 8, ["disabled"])
          ])
        ],
        32
  ...
  const PagesAddAdd = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-e8d2fd40"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/add/add.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        imagePaths: [],
    ...
    methods: {
      ...
      onSubmit(event) {
        ...
        formData.append("leibie", this.formValue.leibie || "");
        formData.append("content", this.formValue.content);
        formData.append("time", Date.now());
        if (this.imagePaths.length > 0) {
          this.imagePaths.forEach((filePath, index) => {
        ...
        axios$1.post("http://127.0.0.1:5000/api/articles", formData, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        }).then((res) => {
          ...
          formatAppLog("error", "at pages/tianjia/tianjia.vue:113", "Error submitting form:", error);
          uni.showToast({
            title: "发布失败，请稍后再试",
            icon: "none",
            duration: 2e3
      ...
      // 判断按钮是否禁用
      inDisabled(obj) {
        let bool = Object.keys(obj).some((key) => obj[key] === "");
        return bool;
      },
      // 重置表单
      resetForm() {
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "add" }, [
      vue.createElementVNode(
        "form",
        {
          onSubmit: _cache[5] || (_cache[5] = (...args) => $options.onSubmit && $options.onSubmit(...args))
        },
        [
          ...
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.formValue.title = $event),
                type: "text",
                name: "title",
                placeholder: "请输入标题"
              },
              ...
              [vue.vModelText, $data.formValue.title]
            ])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              "input",
              {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.formValue.leibie = $event),
                type: "text",
                name: "leibie",
                placeholder: "请输入类型"
              },
              ...
              [vue.vModelText, $data.formValue.leibie]
            ])
          ]),
          vue.createElementVNode("view", { class: "item" }, [
            vue.withDirectives(vue.createElementVNode(
              ...
              {
                maxlength: "-1",
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.formValue.content = $event),
                name: "content",
                placeholder: "请输入详细内容"
              },
              null,
              ...
              [vue.vModelText, $data.formValue.content]
            ])
          ]),
          vue.createCommentVNode(" 图片选择按钮 "),
          vue.createElementVNode("view", { class: "item" }, [
            vue.createElementVNode("button", {
              onClick: _cache[3] || (_cache[3] = vue.withModifiers((...args) => $options.chooseImages && $options.chooseImages(...args), ["stop"])),
              type: "default"
            }, "选择图片"),
            $data.previewImages.length ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              ...
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList($data.previewImages, (image, index) => {
          ...
          vue.createElementVNode("view", { class: "item" }, [
            ...
            vue.createElementVNode("button", {
              "form-type": "submit",
              type: "primary",
              disabled: $options.inDisabled($data.formValue)
            }, "提交", 8, ["disabled"])
          ])
        ],
        32
  ...
  const PagesTianjiaTianjia = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-9802c41e"], ["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/pages/tianjia/tianjia.vue"]]);
  __definePage("pages/index/index", PagesIndexIndex);
  __definePage("pages/log/log", PagesLogLog);
  __definePage("pages/register/register", PagesRegisterRegister);
  __definePage("pages/news/news", PagesNewsNews);
  __definePage("pages/searchpw/searchpw", PagesSearchpwSearchpw);
  __definePage("pages/add/add", PagesAddAdd);
  __definePage("pages/tianjia/tianjia", PagesTianjiaTianjia);
  const _sfc_main = {
    onLaunch: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/Administrator/Documents/HBuilderProjects/课设/App.vue"]]);
  function createApp() {
